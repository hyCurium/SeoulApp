...
public class SeoulFacilitiesAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    private FacilitiesFragment facilitiesFragment = null;
    String dataSet="";
    ...
    public SeoulFacilitiesAsyncTask(HashMap<String, String> location, FacilitiesFragment facilitiesFragment) {
...
//        }
    ...
    protected void onPostExecute(String s) {
        ...
        facilitiesFragment.setLocation(getAllItemList,dataSet);
//        try {
